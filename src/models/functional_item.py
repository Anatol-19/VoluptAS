...
class FunctionalItem(Base):
    ...
    parent_id = Column(
        Integer, ForeignKey("functional_items.id"), nullable=True, index=True
    )
    ...
    parent = relationship("FunctionalItem", remote_side=[id], back_populates="children")
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "responsible_dev": (
                self.responsible_dev.name if self.responsible_dev else None
            ),
    ...
    def is_documented(self) -> bool:
        ...
        return bool(
            self.documentation_links and len(self.documentation_links.strip()) > 0
        )
