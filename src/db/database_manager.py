...
class DatabaseManager:
    ...
    def get_session(self) -> Session:
        ...
        if not self.SessionLocal:
            raise RuntimeError("БД не подключена. Вызовите connect_to_database() сначала.")
    ...
    def init_database(self):
        ...
        """
        if not self.engine:
            raise RuntimeError("Engine не создан. Вызовите connect_to_database() сначала.")
        ...
        logger.info("   Таблицы: functional_items, users, functional_item_relations, "
