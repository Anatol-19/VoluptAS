...
class ReportGeneratorDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.result_text.setPlaceholderText(
            'Нажмите "Сгенерировать" для создания отчёта...'
        )
    ...
    def generate_report(self):
        ...
        try:
            ...
            self.generated_content = generator.generate_report(
                template_id, filters=filters
            )
            ...
            QMessageBox.critical(
                self, "Ошибка", f"Не удалось сгенерировать отчёт:\n\n{e}"
            )
