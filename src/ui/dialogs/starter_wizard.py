...
class StarterWizard(QDialog):
    ...
    def init_ui(self):
        ...
        self.qa_template_btn = QRadioButton("🧪 QA Management — Управление тестированием")
        self.qa_template_btn.setStyleSheet("font-size: 11pt; padding: 10px;")
        self.qa_template_btn.toggled.connect(lambda checked: self.on_template_selected('qa'))
        ...
        self.product_template_btn = QRadioButton("📦 Product Development — Разработка продукта")
        self.product_template_btn.setStyleSheet("font-size: 11pt; padding: 10px;")
        self.product_template_btn.toggled.connect(lambda checked: self.on_template_selected('product'))
        ...
        self.voluptas_template_btn = QRadioButton("📘 VoluptAS Documentation — Фрактальная документация")
        self.voluptas_template_btn.setStyleSheet("font-size: 11pt; padding: 10px;")
        self.voluptas_template_btn.setChecked(True)
        self.voluptas_template_btn.toggled.connect(lambda checked: self.on_template_selected('voluptas'))
        ...
        self.empty_template_btn.toggled.connect(lambda checked: self.on_template_selected('empty'))
                        ...
                        'epics': [
                            ...
                            },
                            {
                                ...
                                'features': [
                                    ...
                                    {'title': 'CI/CD Integration', 'segment': 'Integration'},
                                ]
                            },
                        ]
                    }
                ...
                'modules': [
                    {
                        ...
                        'epics': [
                            ...
                            },
                            {
                                ...
                                'features': [
                                    {'title': 'Назначение ответственных', 'segment': 'UI'},
                                ]
                            },
                            {
                                'title': 'Граф связей',
    ...
    def apply_template(self):
        ...
        for module_data in template_data['modules']:
            ...
            for epic_data in module_data.get('epics', []):
                # Создаём Epic
                epic = FunctionalItem(
                    functional_id=generate_funcid('Epic', epic_data['title'], module=module.title),
                ...
                for feature_data in epic_data.get('features', []):
                    ...
                    feature = FunctionalItem(
                        functional_id=generate_funcid('Feature', feature_data['title'], module=module.title, epic=epic.title),
