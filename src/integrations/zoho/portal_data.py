...
def create_defect_status_manager():
    ...
    defect_statuses_data = [
        {
            "sequence": 1,
            "status_id": "1209515000000007045",
            "status_name": "Open",
            "is_default_value": True,
        },
        {
            "sequence": 2,
            "status_id": "1209515000006897235",
            "status_name": "Dev Working",
            "is_default_value": False,
        },
        {
            "sequence": 3,
            "status_id": "1209515000007512002",
            "status_name": "Pending Test Deploy",
            "is_default_value": False,
        },
        {
            "sequence": 4,
            "status_id": "1209515000006897226",
            "status_name": "Ready for Test",
            "is_default_value": False,
        },
        {
            "sequence": 5,
            "status_id": "1209515000006898002",
            "status_name": "BackLog",
            "is_default_value": False,
        },
        {
            "sequence": 6,
            "status_id": "1209515000000007054",
            "status_name": "Closed",
            "is_default_value": False,
        },
        {
            "sequence": 7,
            "status_id": "1209515000000007057",
            "status_name": "Reopen",
            "is_default_value": False,
        },
        {
            "sequence": 8,
            "status_id": "1209515000007031151",
            "status_name": "Complete",
            "is_default_value": False,
        },
        {
            "sequence": 9,
            "status_id": "1209515000000007048",
            "status_name": "In progress",
            "is_default_value": False,
        },
        {
            "sequence": 10,
            "status_id": "1209515000000007051",
...
def create_user_manager():
    ...
    users_data = [
        ...
        },
        {
            ...
            "name": "Сергей Шевцов",
            "role": "admin",
            "email": "sergey.shevtsov@itspecial.net",
        ...
        },
        {
            ...
            "name": "Arthur Mirzoev",
            "role": "SEO",
            "email": "arthur@vrbangers.com",
            "name_ru": "Артур Мирзоев",
        },
        {
            "id": 24264590,
            "name": "Evgeny Mishenko",
            "role": "admin",
            "email": "e.mishenko@itspecial.net",
        ...
        },
        {
            ...
            "role": "admin",
            "email": "andrey@vrbangers.com",
            "name_ru": "Андрей Васильев",
        },
        {
            "id": 743258772,
            "name": "Sergey Lysenkov",
            "role": "QA",
            "email": "s.lysenkov@itspecial.net",
        ...
        },
        {
            ...
            "name": "Akim Antropov",
            "role": "PM",
            "email": "a.antropov@itspecial.net",
            "name_ru": "Аким Антропов",
        },
        {
            "id": 780778478,
            "name": "Vladimir German",
            "role": "UX/Ui",
            "email": "vladimir@swearl.com",
            "name_ru": "Владимир Герман",
        },
        {
            "id": 780776404,
            "name": "Vitaliy Davydov",
            "role": "Manager",
            "email": "v.davydov@itspecial.net",
        ...
        },
        {
            ...
            "name": "Maria Manyk",
            "role": "Employee",
            "email": "maria@swearl.com",
            "name_ru": "Мария Маник",
        },
        {
            "id": 811688812,
            "name": "Vladimir Lisevich",
            "role": "Dev Back",
            "email": "v.lisevich@itspecial.net",
            "name_ru": "Владимир Лисевич",
        },
        {
            "id": 816882747,
            "name": "Anatol Kiseleow",
            "role": "QA",
            "email": "a.kiselev@itspecial.net",
        ...
        },
        {
            ...
            "name": "Danil Babenkov",
            "role": "Dev Front",
            "email": "d.babenkov@itspecial.net",
        ...
        },
        {
            ...
            "name": "Fedor Garanin",
            "role": "Dev Front",
            "email": "f.garanin@itspecial.net",
            "name_ru": "Федор Гаранин",
        },
        {
            "id": 837019002,
            "name": "Maxim Achapovskiy",
            "role": "QA",
            "email": "m.achapovskiy@itspecial.net",
            "name_ru": "Максим Ачаповский",
        },
        {
            "id": 850833916,
            "name": "Maria Alekseeva",
            "role": "Dev Back",
            "email": "m.alekseeva@itspecial.net",
            "name_ru": "Мария Алексеева",
        },
        {
            "id": 850359581,
            "name": "Dmitriy Pasichnyk",
            "role": "Employee",
            "email": "dp@swearl.com",
        ...
        },
        {
            ...
            "name": "Anton Kazakoff",
            "role": "PM",
            "email": "a.kazakov@itspecial.net",
            "name_ru": "Антон Казаков",
        },
        {
            "id": 868403565,
            "name": "Nikita Molostov",
            "role": "QA",
            "email": "n.molostov@itspecial.net",
            "name_ru": "Никита Молостов",
        },
        {
            "id": 868817959,
            "name": "Stepan Zhiravetckii",
            "role": "QA",
            "email": "s.zhiravetskiy@itspecial.net",
            "name_ru": "Степан Жиравецкий",
        },
        {
            "id": 871064308,
            "name": "Vladislav Nezvanov",
            "role": "Dev Front",
            "email": "v.nezvanov@itspecial.net",
